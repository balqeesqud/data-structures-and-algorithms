...
public class HashMap<K, V> {
    ...
    public Map<String, String[]> leftJoin(Map<String, String> synonymMap, Map<String, String> antonymMap) {
        Map<String, String[]> result = new java.util.HashMap<>(); // built-in hashmap

        for (Map.Entry<String, String> entry : synonymMap.entrySet()) {
            String key = entry.getKey();
            String synonymValue = entry.getValue();
            String antonymValue = antonymMap.getOrDefault(key, null);

            result.put(key, new String[]{synonymValue, antonymValue});
        }
